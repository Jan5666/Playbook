...
// DashboardView moved to pb-views.js (Phase 4 inc 24). PortfolioPieChart + fmtNum stay in app.js
// (PortfolioPieChart is also used by TFSAView) and are reached via the PBApp bridge; the two
// contribution modals are read from PBModals at render time. Bind the view here for the App tab switch.
...
// HeatmapFullscreen + HeatmapView moved to pb-views.js (Phase 4 inc 23). HeatmapTreemap +
// ZoomPanHeatmap stay in app.js (ZoomPanHeatmap is also used by pb-modals SectorDetailModal)
// and are reached from the bucket via the PBApp bridge; SectorDetailModal is read at render
// time inside HeatmapView. Bind the view here for the App tab switch.
